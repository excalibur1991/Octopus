...
import {styles} from '../styles/beginimageannotate';
...
const BeginImageAnnotate = ({navigation, route}) => {
        ...
        <View style={styles.button}>
          <LinearGradient
            ...
            <Ripple
              ...
              onPress={() => navigation.navigate('ImageAnnotate')}>
...
export default BeginImageAnnotate;
