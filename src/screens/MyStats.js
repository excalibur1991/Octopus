...
import { claimRwards } from '../services/API/APIManager';
...
//console.log({total:totalRewards, claimable:claimableRewards,alreadyClaimed:totalRewards-claimableRewards})
    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.topContainer}>
          ...
          <View style={styles.boxContainer}>
            <View style={styles.boxMini}>
              <Text style={styles.itemTitle}>{t('Claimable Rewards')}</Text>
              <Text style={styles.miniBoxValue}>{claimableRewards}</Text>
             <Text style={styles.miniBoxFooter}>{t('WEI')}</Text>
            </View>
          </View>
          <View style={styles.boxContainer}>
            <View style={styles.boxMini}>
              <Text style={styles.itemTitle}>{t('Already Claimed')}</Text>
              <Text style={styles.miniBoxValue}>{alreadyClaimed}</Text>
             <Text style={styles.miniBoxFooter}>{t('WEI')}</Text>
            </View>
          </View>
