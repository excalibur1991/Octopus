...
import {styles} from '../styles/beginimageverify';
...
const BeginImageVerify = ({navigation, route}) => {
        ...
        <View style={styles.button}>
          <LinearGradient
            ...
            <Ripple
              ...
              onPress={() => navigation.navigate('ImageVerify')}>
...
export default BeginImageVerify;
