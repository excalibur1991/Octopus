  ...
  return (
    <View style={styles.container}>
      <View style={styles.CardWrapper}>
        <Image style={styles.leftbar} source={require('../assets/left.png')} />
      ...
      <ScrollView
        ...
        <MultiSelect
          ...
          selectedItemTextColor={theme.COLORS.LIGHT_BLUE}
          selectedItemIconColor={theme.COLORS.LIGHT_BLUE}
          styleDropdownMenu={{height: 56}}
          styleInputGroup={{backgroundColor: theme.APP_COLOR_2}}
          styleItemsContainer={{
